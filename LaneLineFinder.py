...
def get_curverad(out_img, left_fit, right_fit):
...
def draw_lines(warped, out_img, undist, left_fit, right_fit):
    ...
    curverad = get_curverad(out_img, left_fit, right_fit)
...
def process_image(image):
    ...
    result = draw_lines(binary_warped, out_img, undistorted, left_fit, right_fit)
...
if(photo):
    ...
    video_output = "output_images/project_video2.mp4"
